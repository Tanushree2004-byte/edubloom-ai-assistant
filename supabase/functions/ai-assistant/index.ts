...
serve(async (req) => {
  ...
  try {
    ...
    if (mode === "summarize") {
      systemPrompt = "You are a study assistant. Summarize the given text concisely, highlighting key points with bullet points.";
    } else if (mode === "questions") {
      systemPrompt = "You are a study assistant. Generate exactly 5 practice questions with answers for the given topic. Format: Q1: question\\nA1: answer\\n\\nQ2: ...";
    } else {
